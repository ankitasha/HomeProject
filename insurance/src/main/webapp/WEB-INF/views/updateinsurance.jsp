          ...
          <form method="post" action="/insurance/updateInsurance">
             <center>
                <table d="myTable" border="1" width="30%" cellpadding="3" style="background-color: #ECE5B6;" WIDTH="30%">
                    ...
                    <tr>
                        <td> New Insurance Code : </td><td> <input name="insurancecode" placeholder="${name}"/> </td> 
                    </tr>
                   <tr>
                   ...
                   <tr>
                        <td> New Customer : </td><td> <input name="customer.customerId" placeholder="${customer.customerId}"/> </td> 
                    </tr>
                    <tr>
